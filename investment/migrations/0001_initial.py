    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InflationRates', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), null=True, size=None)),
                ('CapitalGrowthRates', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(default=0), null=True, size=None)),
                ...
                ('RepairsAndMaintainance', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), null=True, size=None)),
                ('Specialexpenses', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), null=True, size=None)),
                ('AdditionalLoanPayments', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), null=True, size=None)),
                ('Capitalincome', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), null=True, size=None)),
                ...
                ('renovations_own_list', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(), size=None)),
                ('renovations_loan_list', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(), size=None)),
