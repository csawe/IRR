...
InterestRateFormSet = forms.formset_factory(
    InterestRateFormRate, extra=0
)  # Interest Rate Options -- Rate form
...
InflationRatesFormSet = forms.formset_factory(
    InflationRateFormRate, extra=0
)  # Inflation Rates -- Rate form
...
CapitalGrowthRatesFormSet = forms.formset_factory(
    CapitalGrowthRatesFormRate, extra=0
)  # Capital Growth Rate
...
OwnRenovationsFormSet = forms.formset_factory(
    OwnRenovationsFormJson, extra=0
)  # Own renovations
...
LoanRenovationsFormSet = forms.formset_factory(
    LoanRenovationsFormJson, extra=0
)  # Loan renovations
...
RepairsAndMaintenanceFormSet = forms.formset_factory(
    RepairsAndMaintenanceForm, extra=0
...
SpecialExpensesFormSet = forms.formset_factory(
    SpecialExpensesForm, extra=0
)  # Special Expenses
...
AdditionalLoanPaymentFormSet = forms.formset_factory(
    AdditionalLoanPaymentsForm, extra=0
)  # Additional Loan Payments


class CapitalIncomeForm(forms.Form):
    capital_income = forms.IntegerField()


CapitalIncomeFormSet = forms.formset_factory(
    CapitalIncomeForm, extra=0
)  # Capital Income


class RentalIncomeAmountForm(forms.Form):
    rental_income = forms.IntegerField()
